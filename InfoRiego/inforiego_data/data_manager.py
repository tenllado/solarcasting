...
class DataManager(object):
    """This class downloads and uncompresses all files from InfoRiego than passes the criteria"""
    ...
    def get_data(self):
        """ This function downloads, uncompresses and corrects the data """
    ...
    def _uncompress_and_save_zip(self, zip_file):
        """ This function uncompresses a zip file and saves it to disk """
    ...
    def _download_zip(self, uri, link):
        ...
        path = parse.urlparse(zip_url).path.split('/')[-1]
       ...
       #downloading zip file
        ...
        # open url
            zip_file = request.urlopen(zip_url)
    ...
    def _get_zip_links(self, req):
        """ This function iterates through all <a> tags of a request and gets all zip links """
    ...
    def _get_year_links(self, req):
        """ This function gets all links from <a> tag presents in a response """
...
def main():
    ...
    parser.add_argument('-c', '--config-file', nargs='?', action="store", dest="config_file", help="File with the parameters to download the data.")
